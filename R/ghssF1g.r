ghssF1g <- function(params, dat, dat1, dat2, weights=weights, X1.d2, X2.d2, sp=NULL, l.sp1, l.sp2, gp1, gp2, exl1, exl2, qu.mag=NULL){
...
# Settings:
  ...
  settings <- cbind(F1,F2,f2,u,z,p,ph,h,ye)
